...
`veap add <npm-package>` installs a plugin package and runs the same regeneration; `veap eject <package>` copies an installed plugin (or template) into your local workspace folder so you can modify it.
