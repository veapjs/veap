...
To prevent duplicate React instances and Next.js context errors, all plugins declare `react`, `react-dom`, and `@veap/framework` as **peer dependencies**. The host application is responsible for providing the actual installations of these packages.
