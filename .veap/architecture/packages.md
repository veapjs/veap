...
- **`@veap/core`** (`packages/veap`): The framework kernel. Exposes public APIs such as `@veap/core/auth`, `@veap/core/plugins`, `@veap/core/database`, `@veap/core/router` and `@veap/core/settings`, plus the `veap` CLI binary.
