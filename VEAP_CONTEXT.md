...
`@veap/framework` is the unified application framework foundation of the Veap ecosystem, built on Next.js 16, React 19, and TypeScript.
...
- **Relative imports within package**: internal source files use relative imports (`../..`), never self-referencing `@veap/framework/...` package imports.
