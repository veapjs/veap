...
2. If testing transactional logic, wrap the test execution inside the `transaction()` helper from `@veap/framework/database` to simulate the request lifecycle environment.
