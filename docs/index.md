...
This documentation covers `@veap/framework` version **0.11.x**. Code in the repository is the source of truth; where this documentation and the code disagree, the code wins. Please report discrepancies.
